namespace Crm.Article.Database
{
	...
	[Migration(20170523103500)]
	public class UpdateLookupsToEntityLookup : Migration
	{
		public override void Up()
		{
			const string createUser = "Migration_20170523103500";
			AddEntityLookupColumns("Lu", "ArticleType", createUser);
			AddEntityLookupColumns("Lu", "VATLevel", createUser);
		}
