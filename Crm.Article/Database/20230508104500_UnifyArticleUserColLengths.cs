namespace Crm.Article.Database
{
	...
	[Migration(20230508104500)]
	public class UnifyArticleUserColLengths : Migration
	{
		public override void Up()
		{
			(string, string)[] tables = { ("CRM", "ArticleRelationship"), ("LU", "ArticleDescription"), ("LU", "ArticleType"), ("LU", "VATLevel") };
