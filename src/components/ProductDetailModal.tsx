...
import BoxSelectionModal from './modals/BoxSelectionModal';
...
const ProductDetailModal = ({ isOpen, onClose, product }: ProductDetailModalProps) => {
  ...
  const isShirtProduct = location.pathname.includes('/chemises');
  ...
  const handleAddToCart = () => {
    ...
    if (isShirtProduct) {
      ...
      addToCartWithBox(false);
    }
  };

  const addToCartWithBox = (withBox: boolean) => {
